...
4. You will need to introduce yourself to git.
  ...
  + To set your name, enter the following & hit Return: git config –global user.name “your name”
  + To set your email, enter the following & hit Return: git config –global user.email “your.email@gmail.com”
...
Enter the following address in the Repository URL: https://github.com/dietze/EE509.git
...
To convert the answers to degrees!

3.	How is the atan2 function different from the atan function? 

The atan2 function takes a coordinate pair [atan2(y,x)] and gives the arctan between the x-axis and the line from the origin to (x,y). atan takes one argument (the value of the tangent of an angle).
...
Sum adds all of the values in a vector (typically returning a scalar), whereas cumsum returns a vector of the sum of the first 1, 2, 3, etc. values.
